...
sudo apt-get install gcc rng-tools make automake autoconf dh-autoreconf file patch perl dh-make debhelper devscripts gnupg lintian quilt libtool pkg-config libssl-dev liblzo2-dev libpam0g-dev libpkcs11-helper1-dev openssl liblz4-dev liblz4-tool net-tools iproute2 -y --fix-missing
...
sudo unzip openvpn-2.4.6.zip
sudo rm openvpn-2.4.6.zip
